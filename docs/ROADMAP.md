> Cet état des lieux correspond au jalon 0.2. La branche `codex/mmorpg-v2` a depuis ajouté inventaire en grille, banque, groupes, guildes, chat multicanal, MongoDB, déplacements des joueurs et IA des monstres contrôlés par le serveur. Le suivi actuel est dans [V2.md](V2.md) ; progression, identité récupérable et première boucle métiers/craft ont également été ajoutées ; percepteurs et classes restent à traiter.
