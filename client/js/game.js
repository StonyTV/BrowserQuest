...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        init: function(app) {
            ...
            // sprites
            this.spriteNames = ["ashnode", "ironnode", "hand", "sword", "loot", "target", "talk", "sparks", "shadow16", "rat", "skeleton", "skeleton2", "spectre", "boss", "deathknight",
        ...
        connect: function(started_callback) {
            ...
            this.client.selectedCharacterId = this.selectedCharacterId;
